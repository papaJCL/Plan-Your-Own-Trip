...
export default class Home extends Component {
    ...
    renderItinerary(){
        ...
        var body = places.map((item, idx) => <Pane header= {'Location ' + (idx + 1)} bodyJSX =  {`  Location: ${item.name}  Latitude: ${item.latitude} Longitude: ${item.longitude}  Distance: ${item.distance}`} />);
